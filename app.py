...
# python -m venv venv                     #create the virtual envirnment
# .\venv\Scripts\activate                 # activate venv in windows
# pip install streamlit
# pip install scikit-learn
# pip install python-docx
# pip install PyPDF2
# pip install -r requirements.txt    
#                     #open the website by localhost link 
# ctrl+c                                 # to terminate the running of project
